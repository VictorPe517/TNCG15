...
public:
    ...
    static const int x_res = 500;   //Static:   Shared between all instances of Camera
    static const int y_res = 500;   //Const:    We pinky promise to the compiler that we won't change the resolution of the camera during runtime.
